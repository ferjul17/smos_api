...
var API = /** @class */ (function () {
                        ...
                        page_1.on("domcontentloaded", function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        error = _a.sent();
                                        if (!/Logged success/.test(error)) return [3 /*break*/, 4];
                                        return [4 /*yield*/, this.saveCookie(page_1)];
                                    case 2:
                                        _a.sent();
                                    ...
                                    case 3:
                                        ...
                                        return [3 /*break*/, 8];
                                    case 4:
                                        if (!(/Invalid captcha/.test(error) && retryCount_1++ < 3)) return [3 /*break*/, 6];
                                        return [4 /*yield*/, this.doLogin(page_1)];
                                    case 5:
                                        _a.sent();
                                        return [3 /*break*/, 8];
                                    case 6: return [4 /*yield*/, page_1.close()];
                                    case 7:
                                        _a.sent();
     ...
     */
    API.prototype.getPage = function (browser) {
        return Promise.all([
            (browser ? Promise.resolve(browser) : this.getBrowser())
                .then(function (b) { return b.newPage(); }),
            this.getCookie(),
            ...
            debugger;
            if (cookies.length) {
                return page.setCookie.apply(page, cookies).then(function () { return page; });
            }
            return page;
        });
    };
     ...
     * @returns {Promise<void>}
     */
    API.prototype.saveCookie = function (page) {
        return page.cookies().then(function (cookies) {
            var cookieDir = path_1.dirname(COOKIE_PATH);
            var cookieStr = JSON.stringify(cookies);
            var writeJarPromiseFn = function () { return writeFileAsync(COOKIE_PATH, cookieStr); };
     ...
     */
    API.prototype.getCookie = function () {
        return new Promise(function (resolve) {
            readFileAsync(COOKIE_PATH).then(function (str) {
                try {
